...
import uk.gov.hmrc.app.benefitEligibility.integration.outbound.individualStatePensionInformation.model.IndividualStatePensionInformationSuccess.*
import uk.gov.hmrc.app.benefitEligibility.integration.outbound.individualStatePensionInformation.model.enums.{CreditSourceType, IndividualStatePensionContributionCreditType}
...
import uk.gov.hmrc.app.benefitEligibility.integration.outbound.longTermBenefitCalculationDetails.model.enums.{CalculationSource, CalculationStatus, Payday}
import uk.gov.hmrc.app.benefitEligibility.integration.outbound.longTermBenefitNotes.model.LongTermBenefitNotesSuccess.{LongTermBenefitNotesSuccessResponse, Note}
...
import uk.gov.hmrc.app.benefitEligibility.integration.outbound.schemeMembershipDetails.model.SchemeMembershipDetailsSuccess.{SchemeMembershipDetails, *}
  ...
  "BenefitEligibilityController" - {
    ".fetchBenefitEligibilityData" - {
      ...
      "should fetch JSA Data correctly" in {
        ...
        server.stubFor(
          WireMock.post(urlEqualTo("/auth/authorise"))
            .willReturn(
              aResponse()
                .withStatus(OK)
                .withHeader("Content-Type", "application/json")
      ...
      "Should Fetch MA Correctly" in {
        ...
        val niContributionsAndCreditsSuccessResponseBody = Json.toJson(niContributionsAndCreditsSuccessResponse).toString()
        ...
        server.stubFor(
          WireMock.get(urlEqualTo(npsClass2MaReceiptsPath))
            .willReturn(
              aResponse()
                .withStatus(OK)
                .withHeader("Content-Type", "application/json")
        ...
        server.stubFor(
          WireMock.get(urlEqualTo(npsLiabilitySummaryDetailsPath))
            .willReturn(
              aResponse()
                .withStatus(OK)
                .withHeader("Content-Type", "application/json")
        ...
        val expectedResult = BenefitEligibilityInfoSuccessResponseMa(Identifier("AB123456C"), class2MAReceiptsSuccessResponse, liabilitySummaryDetailsSuccessResponse, niContributionsAndCreditsSuccessResponse)
      ...
      "Should Fetch BSP Correctly" in {
        ...
        server.stubFor(
          WireMock.get(urlEqualTo("/individual/AB123456C/marriage-cp"))
            .willReturn(
              aResponse()
                .withStatus(OK)
                .withHeader("Content-Type", "application/json")
        ...
        val expectedResult = BenefitEligibilityInfoSuccessResponseBsp(Identifier("AB123456C"), marriageDetailsSuccessResponse, successResponse)
      ...
      "Should Fetch GYP Correctly" in {
        ...
        server.stubFor(
          WireMock.get(urlEqualTo("/benefit-scheme/AB123456C/benefit-scheme-details/S3123456B"))
            .willReturn(
              aResponse()
                .withStatus(OK)
                .withHeader("Content-Type", "application/json")
        ...
        server.stubFor(
          WireMock.get(urlEqualTo("/long-term-benefits/AB123456C/calculation"))
            .willReturn(
              aResponse()
                .withStatus(OK)
                .withHeader("Content-Type", "application/json")
        ...
        server.stubFor(
          WireMock.get(urlEqualTo("/long-term-benefits/AB123456C/calculation/ALL/notes/86"))
            .willReturn(
              aResponse()
                .withStatus(OK)
                .withHeader("Content-Type", "application/json")
        ...
        server.stubFor(
          WireMock.get(urlEqualTo("/benefit-scheme/AB123456C/scheme-membership-details"))
            .willReturn(
              aResponse()
                .withStatus(OK)
                .withHeader("Content-Type", "application/json")
        ...
        server.stubFor(
          WireMock.get(urlEqualTo("/long-term-benefits/AB123456C/contributions"))
            .willReturn(
              aResponse()
                .withStatus(OK)
                .withHeader("Content-Type", "application/json")
        ...
        val expectedResult = BenefitEligibilityInfoSuccessResponseGysp(Identifier("AB123456C"),List(benefitSchemeDetailsSuccessResponse), marriageDetailsSuccessResponse, longTermBenefitCalculationDetailsSuccessResponse, longTermBenefitNotesSuccessResponse, schemeMembershipDetailsSuccessResponse, individualStatePensionInformationSuccessResponse, List(niContributionsAndCreditsSuccessResponse))
