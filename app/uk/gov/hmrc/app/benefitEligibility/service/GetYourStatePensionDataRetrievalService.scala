...
class GetYourStatePensionDataRetrievalService @Inject() (
  ...
  def fetchEligibilityData(
    ...
    (
      ...
      fetchBenefitSchemeMembershipDetailsData(eligibilityCheckDataRequest.schemeMembershipDetails),
  ...
  private[service] def fetchBenefitSchemeMembershipDetailsData(
    ...
    detailsResult <- schemeMembershipDetailsConnector.fetchSchemeMembershipDetails(
      ...
      sequenceNumber = schemeMembershipDetails.schemeMembershipSequenceNumber,
      transferSequenceNumber = schemeMembershipDetails.schemeMembershipTransferSequenceNumber,
      occurrenceNumber = schemeMembershipDetails.schemeMembershipOccurrenceNumber
    )
    resultTuple <-
      detailsResult match {
