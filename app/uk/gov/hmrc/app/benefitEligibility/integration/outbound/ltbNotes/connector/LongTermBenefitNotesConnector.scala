...
package uk.gov.hmrc.app.benefitEligibility.integration.outbound.ltbNotes.connector
...
import uk.gov.hmrc.app.benefitEligibility.integration.outbound.ltbNotes.mapper.LongTermBenefitNotesResponseMapper
import uk.gov.hmrc.app.benefitEligibility.integration.outbound.ltbNotes.model.response.LongTermBenefitNotesError.*
import uk.gov.hmrc.app.benefitEligibility.integration.outbound.ltbNotes.model.response.LongTermBenefitNotesResponseValidation.longTermBenefitNotesResponseValidator
