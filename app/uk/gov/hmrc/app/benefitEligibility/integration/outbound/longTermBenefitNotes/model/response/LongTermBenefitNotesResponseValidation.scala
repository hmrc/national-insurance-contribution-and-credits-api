...
package uk.gov.hmrc.app.benefitEligibility.integration.outbound.longTermBenefitNotes.model.response
...
object LongTermBenefitNotesResponseValidation {
  ...
  implicit val longTermBenefitNotesResponseValidator: NpsResponseValidator[LongTermBenefitNotesSuccessResponse] = {
