...
object SchemeMembershipDetailsError {
  ...
  case class SchemeMembershipDetailsError400(reason: NpsErrorReason, code: NpsErrorCode400) extends NpsApiResponse
  ...
  case class SchemeMembershipDetailsError422(reason: NpsErrorReason, code: ErrorCode422)
...
object SchemeMembershipDetailsSuccess {
  ...
  object SchemeMembershipDetails {
    implicit val schemeMembershipDetailsFormat: Format[SchemeMembershipDetails] = Json.format[SchemeMembershipDetails]
  }
  ...
  object SchemeMembershipDetailsSummary {
    ...
    implicit val schemeMembershipDetailsSummaryFormat: Format[SchemeMembershipDetailsSummary] =
  ...
  object SchemeMembershipDetailsSuccessResponse {
    ...
    implicit val schemeMembershipDetailsSuccessResponseFormat: Format[SchemeMembershipDetailsSuccessResponse] =
      Json.format[SchemeMembershipDetailsSuccessResponse]
