...
object Class2MAReceiptsError {
  ...
  // 400 start
  case class Class2MAReceiptsError400(reason: NpsErrorReason, code: NpsErrorCode400)
  ...
  // 422 start
  case class Class2MAReceiptsError422(reason: NpsErrorReason, code: ErrorCode422)
