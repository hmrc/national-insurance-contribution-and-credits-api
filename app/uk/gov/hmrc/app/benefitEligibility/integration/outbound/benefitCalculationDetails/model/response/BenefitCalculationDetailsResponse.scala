...
import uk.gov.hmrc.app.benefitEligibility.integration.outbound.liabilitySummaryDetails.model.response.LiabilitySummaryDetailsSuccess.OfficeDetails
...
object BenefitCalculationDetailsError {
  ...
  case class BenefitCalculationDetailsErrorItem400(reason: Reason, code: NpsErrorCode400)
  ...
  case class BenefitCalculationDetailsError422(reason: Reason, code: ErrorCode422)
