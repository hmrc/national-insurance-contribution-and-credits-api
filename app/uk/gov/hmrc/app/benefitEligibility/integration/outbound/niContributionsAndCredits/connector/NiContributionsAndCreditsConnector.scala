...
import uk.gov.hmrc.app.benefitEligibility.common.ApiName.{ContributionCredit, MarriageDetails}
      ...
      .flatMap { response =>
        val contributionsAndCreditsResult =
          response.status match {
            ...
            case NOT_FOUND => Right(DownstreamErrorReport(ContributionCredit, NotFound))
