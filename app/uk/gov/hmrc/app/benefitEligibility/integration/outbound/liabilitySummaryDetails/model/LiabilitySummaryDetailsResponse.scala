...
object LiabilitySummaryDetailsError {
  ...
  case class LiabilitySummaryDetailsError400(reason: NpsErrorReason, code: NpsErrorCode400)
  ...
  case class LiabilitySummaryDetailsError422(reason: NpsErrorReason, code: ErrorCode422)
