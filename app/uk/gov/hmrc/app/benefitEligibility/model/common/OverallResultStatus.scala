...
import uk.gov.hmrc.app.benefitEligibility.model.nps.ApiResult

import scala.collection.immutable

sealed abstract class OverallResultStatus(override val entryName: String) extends EnumEntry
