...
class FakeAuthAction @Inject()(override val parser: BodyParsers.Default, override val authConnector: AuthConnector, config: AppConfig)
                              (implicit override val executionContext: ExecutionContext) extends AuthAction(authConnector, parser, config) {
