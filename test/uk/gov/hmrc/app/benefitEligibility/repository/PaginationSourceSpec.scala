...
import uk.gov.hmrc.app.benefitEligibility.repository.BatchSource.{
  ...
  "BatchSource" - {
    ".fromBenefitSchemeMembershipDetails" - {
      "should return BatchSource if successful BenefitSchemeMembershipDetailsData with callback url" in {
        ...
        result shouldBe Some(BatchSource(ApiName.BenefitSchemeDetails, "SomeURL"))
      }
    ...
    ".fromMarriageDetails" - {
      "should return BatchSource if successful MarriageDetailsResult with callback url" in {
        ...
        result shouldBe Some(BatchSource(ApiName.MarriageDetails, "SomeUrl"))
      }
    ...
    ".fromLiabilities" - {
      "should return BatchSource if successful LiabilityResult with callback url" in {
        ...
        result shouldBe List(BatchSource(Liabilities, "SomeUrl"))
      }
