...
import uk.gov.hmrc.app.benefitEligibility.integration.inbound.JSAEligibilityCheckDataRequest
...
class JobSeekersAllowanceDataRetrievalServiceSpec extends AnyFreeSpec {

  implicit val ec: ExecutionContextExecutorService =
    ExecutionContext.fromExecutorService(Executors.newSingleThreadExecutor())

  val underTest = new JobSeekersAllowanceDataRetrievalService()
    ...
    ".fetchEligibilityData" - {
      "should retrieve data successfully" in {
        underTest
          ...
          .value
          .futureValue shouldBe Right(EligibilityCheckDataResultJSA())
